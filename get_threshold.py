...
def main():  
    ...
    for doy in range(1, 366):
        ...
        thresholds[0, doy-1, :, :] = np.percentile(window_data, 1, axis = 0)
        thresholds[1, doy-1, :, :] = np.percentile(window_data, 5, axis = 0)
        thresholds[2, doy-1, :, :] = np.percentile(window_data, 10, axis = 0)
